                ...
                <div class="tab_container min_height">
                    ...
                    if (!is_null($page_data)) {
                        ...
                        <div class="accordion">
                            ...
                            else echo 'false'; ?>" aria-controls="accordion1" class="accordion-title accordionTitle js-accordionTrigger <?php if ($l == 1) { ?> is-collapsed is-expanded <?php } ?>">{{$value->title_bn;}}</a>
                                    </dt>
