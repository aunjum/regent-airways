...
?>
<header @if(!$news_data) style="height: 120px;" @endif>
    <nav id="navbar">
        <div class="quick-access">
            <div class="contact-access container2">
                ...
                <div class="pull-left ">
                    <a href="{{ URL::to('/') }}/">
                        <?php if($company_data) { ?>
                        <img src="{{ Helper::getImageBaseUrl() }}/public/upload/blog/{{$company_data[0]->image}}" class="sitelogo"/>
                        <?php } ?>
                    </a>
                </div>
                ...
                <div class="pull-right contact_container">
                    ...
                    {{--<img src="{{ URL::to('/') }}/public/images/and.png">Download App--}}
                    {{--</a>--}}
            ...
            <div id="navinner" class="container">
                ...
                <!--<li class="dropdown">
                    ...
                    <li class="dropdown">
                        ...
                        <!-- <li><a href="{{ URL::to('/') }}/flight-status">Flight Status</a></li>-->
                        </ul>
                    </li>
                    <li class="dropdown">
...
<div class="modal hide fade adv_popup" id="myModal">
    ...
    <!--		<img src="{{ Helper::getImageBaseUrl() }}/public/upload/blog/{{$pop_image}}">-->
...
<?php
Session::put('ses_id', Session::getId());
