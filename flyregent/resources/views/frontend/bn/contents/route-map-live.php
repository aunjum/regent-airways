...
<div id="panel">
    <a href="javascript:collapse()" id="collapse_button">বন্ধ</a>
    <div class="text-left pull-left">
        <h2 class="search_title">রিজেন্ট ফ্লাইট অনুসন্ধান</h2>
    </div>
    
    <div class="text-right back pull-right">
        <a href="<?php echo URL::to('/') ?>/route-map" style="">
            <img src="<?php echo URL::to('/') ?>/public/images/back.png"/>পিছনে
        </a>
    </div>
    ...
    <div class="form-group byflightid_container">
        <label for="inputEmail3" class="col-sm-2 control-label">ফ্লাইট আইডি দ্বারা অনুসন্ধান<span class="required">*</span></label>
        <div class="clearfix"></div>
        <div class="col-sm-4 pull-left">
            <input type="text" class="form-control flightid" id="flight_id" placeholder="e.g. RX782" required>
        </div>
        <div class="col-sm-4">
            <button type="button" class="btn btn-primary pull-left" onclick="locate_point_by_flight()">অনুসন্ধান</button>
        </div>
    </div>
    ...
    <label for="inputEmail3" class="col-sm-2 control-label pull-left">রুট দ্বারা অনুসন্ধান<span class="required">*</span></label>
    <br/>
    <div class="clearfix"></div>
    <div>
        
    <select class="form-control pull-left" id="address1">
        <option value="">উড্ডয়ন হতে</option>
        <option value="Dhaka">ঢাকা</option>
        <option value="Chittagong">চট্টগ্রাম</option>
        <option value="Cox's Bazar">কক্সবাজার </option>
        <option value="Bangkok">ব্যাংকক</option>
        <option value="Kuala Lumpur">কুয়ালালামপুর</option>
    ...
    <select class="form-control pull-left" id="address2">
        <option value="">উড্ডয়ন পর্যন্ত</option>
        <option value="Dhaka">ঢাকা</option>
        <option value="Chittagong">চট্টগ্রাম</option>
        <option value="Cox's Bazar">কক্সবাজার </option>
        <option value="Bangkok">ব্যাংকক</option>
	...
	<option value="Muscat">মাস্কাট</option>
        ...
        <button type="button" class="btn btn-primary pull-left" onclick="locate_point()">অনুসন্ধান</button>
