                        ...
                        <div class="accordion">
                            <dl>
                                ...
                                foreach ($page_data as $value) {
                                    ...
                                    <dt>
                                    <a href="#accordion{{$l}}" aria-expanded="<?php
                                    if ($l == 1)
                                        echo 'true';
                                    else
                                        echo 'false';
                                    ?>" aria-controls="accordion1" class="accordion-title accordionTitle js-accordionTrigger <?php if ($l == 1) { ?> is-collapsed is-expanded <?php } ?>">{{$value->title_bn;}}</a>
                                    </dt>
                                    <dd class="accordion-content accordionItem <?php
                                    if ($l == 1)
                                        echo 'is-expanded';
                                    else
                                        echo 'is-collapsed';
                                    ?>" id="accordion{{$l}}" aria-hidden="true">
