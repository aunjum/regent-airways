                        ...
                        <div class="flyregent-text-holder essential-information">
                            ...
                            <div class="flyregent-text-inner">
                                ...
                                <div class="flyregent-text">
                                    <?php 
                                    $len = strlen($ess->description);
                                    if( $len > 650){ 
                                        
                                        echo '<div class="less_contents_'.$sl.'">'.substr(($ess->description), 0, 650).' ... <a href="javascript:show_more('.$sl.')">See More</a></div>';
                                        
                                    }else{
                                        echo $ess->description;
                                    }
                                    ?>
                                        {{--todo: sts changes--}}

                                        <div class="more_contents_{{$sl}} none">{!! $ess->description !!} <a href="javascript:less({{$sl}})">See Less</a></div>
                                </div>
